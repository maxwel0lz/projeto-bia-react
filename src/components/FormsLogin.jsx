import { ArrowBigDown, LockKeyhole, MailIcon } from "lucide-react"
...
function FormsLogin(){
    ...
    const st = largura < 650? "w-full":"w-[52%]"

    return(
        <>
            <div className="flex flex-col gap-3 items-center">
                <h1 className="text-pink-500 text-center font-serif text-5xl">Faça login na sua conta</h1>
